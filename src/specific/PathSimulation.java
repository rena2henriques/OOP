...
public class PathSimulation extends SimulationA {
	...
	public PathSimulation(File file, ) {
		...
		super.setFinalTime(finalinst);	//<--MUDAR ISTO	CONSOANTE O XML // n�o � preciso fazer assim, posso aceder logo
...
*/
	...
	public void simulate() {
		...
		while(currentEvent!=null && currentTime< finalTime) {
			...
			//fazer try and catch com excep��es: a cena da epidemia,
			//FAZER TRY AND CATCH COM EPIDEMIA,  	
			//excep��o para ver se j� acabou?, outra excep��o?
	...
	//CHECKAR VISIBILIDADES DAS FUN�OES?
	void reset() {
